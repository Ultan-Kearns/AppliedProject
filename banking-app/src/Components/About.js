    ...
    <div className="About">
      ...
      <div className="liesWeTellCustomers" id="left">
        <Card style={{ width: "50vw" }}>
          <Card.Header>Welcome to the only bank you'll ever need!</Card.Header>
          <Image
          ...
          <Card.Body>
            ...
            <Card.Text>
              Yes we know you have heard this blaise comment before but we
              really mean it, just because we are a massive corporation whose
              only objective is to make a profit doesn't mean we don't care! I
              mean look at how happy our customers are! You too can be happy if
              you just give us all your business and a tonne of money!
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
        <Card style={{ width: "46vw" }} className="liesWeTellCustomers" id="right">
          <Card.Header>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              about your personal well-being, if something were to happen to you
              how in the world could we make money off you? That's why we care!
            </Card.Text>
          </Card.Body>
        </Card>
      <div className="liesWeTellCustomersBottom" id="left">
        <Card>
          <Card.Header>Our evil..... I mean our plans</Card.Header>
          <Card.Body>
            <Card.Title>Our Aims</Card.Title>
            <Card.Text>
              We aim to provide you, {sessionStorage.getItem("username")}, YES
              YOU! with a site that is:
            </Card.Text>
            <ul>
              <li>
